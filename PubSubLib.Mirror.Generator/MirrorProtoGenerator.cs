...
public sealed class MirrorProtoGenerator : IIncrementalGenerator
{
    ...
    private static MirrorClassInfo? TransformClass(GeneratorAttributeSyntaxContext ctx)
    {
        ...
        return new MirrorClassInfo(ns, classSymbol.Name, fullProtoName, fields.ToArray());
    }
...
internal readonly struct MirrorClassInfo
{
    ...
    public MirrorClassInfo(string ns, string className, string protoTypeFullName, FieldMapping[] fields)
    {
        Namespace = ns;
        ClassName = className;
